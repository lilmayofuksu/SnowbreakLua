...
function ScreenEditor:OnCalcBulletLocAndRot()    
    ...
    self.GenerateRotation.Pitch = self.GenerateRotation.Pitch + UE4.UKismetMathLibrary.Lerp(-25, 25, 1.0 * self.GenerateCount/self.BulletNum)
