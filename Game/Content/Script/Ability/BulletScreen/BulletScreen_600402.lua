...
function ScreenEditor:OnCalcBulletLocAndRot()    
    ...
    local V50 = UE4.FVector(0, 0, 50)
    self.GenerateLocation01 = UE4.UKismetMathLibrary.GetForwardVector(self.GenerateRotation01) * 120 + self.DefaultLocation + V50
    self.GenerateLocation02 = UE4.UKismetMathLibrary.GetForwardVector(self.GenerateRotation02) * 120 + self.DefaultLocation + V50
end
