...
function ScreenEditor:OnCalcBulletLocAndRot()    
    ...
    self.GenerateRotation.Yaw = self.GenerateRotation.Yaw + UE4.UKismetMathLibrary.Lerp(-25, 25, 1.0 * self.GenerateCount/self.BulletNum)
