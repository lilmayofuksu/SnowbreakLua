...
function ScreenEditor:OnCalcBulletLocAndRot()    
    ...
    self.GenerateLocation = UE4.UKismetMathLibrary.GetForwardVector(self.GenerateRotation) * 30 + self.DefaultLocation + UE4.FVector(0, 0, 30)
end
