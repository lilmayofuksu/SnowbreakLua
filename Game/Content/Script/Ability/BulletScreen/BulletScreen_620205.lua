...
function ScreenEditor:OnCalcBulletLocAndRot()    
    ...
    ActorLoc = ActorLoc + UE4.UKismetMathLibrary.GetForwardVector(ActorRot) * (self.RandomFloat(-25, 25) + 100)
    ActorLoc = ActorLoc + UE4.UKismetMathLibrary.GetUpVector(ActorRot) * self.RandomFloat(-50, 50)
