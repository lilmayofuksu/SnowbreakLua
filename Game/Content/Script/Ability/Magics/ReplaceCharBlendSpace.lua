---@class Magic_ReplaceCharBlendSpace:Magic
local Magic = Ability.DefineMagic('ReplaceCharBlendSpace');
...
function Magic:OnBorn(AbilityTarget,Modifier, Parameter, bKeepEffect)
    ...
    if Character ~= nil and Character:GetGameAnimInstance() ~= nil then
        Character:GetGameAnimInstance():ReplaceBlendSpaceByVariableName(OldAnimSeqName,NewAnimSeqName,bLoadAnim_External);
    end
    return true;
end
...
function Magic:OnRemove(AbilityTarget,Modifier, Parameter)
    ...
    if Character ~= nil and Character:GetGameAnimInstance() ~= nil then
        Character:GetGameAnimInstance():ReplaceBlendSpaceByVariableName(OldAnimSeqName,OldAnimSeqName,false);
    end
    return true;
end
