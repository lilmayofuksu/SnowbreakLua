---@class SummonSetLifeTime:Magic
local Magic = Ability.DefineMagic('SummonSetLifeTime');
            ...
            if lpSummon then                
                ...
                if nSummonID <= 0 or AppearID == nSummonID then            
                    ...
                    if nLifeSpan > 0 then
                        ...
                        if bPercent then
                            lpSummon:SetLifeSpan(nInitialLifeSpan * nLefeTimePer * 0.01)
                        else
                            lpSummon:SetLifeSpan(nLifeTime)
                        end
