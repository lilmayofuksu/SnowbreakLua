---@class Magic_ReplaceCharAnimMontage:Magic
local Magic = Ability.DefineMagic('ReplaceCharAnimMontage');
...
function Magic:OnBorn(AbilityTarget,Modifier, Parameter, bKeepEffect)
    ...
    if Character ~= nil and Character:GetGameAnimInstance() ~= nil then
        Character:GetGameAnimInstance():ReplaceMontageByVariableName(OldAnimSeqName,NewAnimSeqName,bLoadAnim_External);
    end
    return true;
end
...
function Magic:OnRemove(AbilityTarget,Modifier, Parameter)
    ...
    if Character ~= nil and Character:GetGameAnimInstance() ~= nil then
        Character:GetGameAnimInstance():ReplaceMontageByVariableName(OldAnimSeqName,OldAnimSeqName,false);
    end
    return true;
end
