...
local Magic = Ability.DefineMagic('IgnoreAbnormal');
...
function Magic:OnBorn(AbilityTarget,Modifier, Parameter, bKeepEffect)
    ...
    local path = string.format("/Game/Blueprints/Ability/Buffer/State_DisOutControllable.State_DisOutControllable_C");
