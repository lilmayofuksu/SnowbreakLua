-- ========================================================
-- @File    : uw_fight_cross4.lua
-- @Brief   : 准心
-- @Author  :
-- @Date    :
-- ========================================================

local uw_fight_cross4 = Class("UMG.Fight.Widgets.CrossHair.uw_fight_crosshair_base")

uw_fight_cross4.RealHitPos = UE4.FVector2D(0, 0)
function uw_fight_cross4:Tick(MyGeometry, InDeltaTime)
...
function uw_fight_cross4:ShowAim(bInAim,InTarAct,bValue,bPawnState)
    if bInAim then
