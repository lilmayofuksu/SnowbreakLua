-- ========================================================
-- @File    : uw_chess_item_setting_object_id.lua
-- @Brief   : 地图配置 - objectid内容
-- ========================================================
...
function view:OnListItemObjectSet(pObj)
    ...
    local tbObjectIdUsed = ChessEditor:GetObjectIdUsed(self.tbData.id)
    local ShowBtnSelect = #tbObjectIdUsed == 0
    self.TxtCount:SetText(#tbObjectIdUsed)
    self.TxtRef:SetText(#ChessEditor:GetObjectIdRefrence(self.tbData.id))
...
function view:OnBtnClickCount()
    ...
    local tbParam = {
        ...
        tbList = ChessEditor:GetObjectIdUsed(self.tbData.id)
    }
...
function view:OnBtnClickRef()
    ...
    local tbParam = {
        ...
        tbList = ChessEditor:GetObjectIdRefrence(self.tbData.id)
    }
    EventSystem.Trigger(Event.NotifyChessOpenFastJump, tbParam)
end
