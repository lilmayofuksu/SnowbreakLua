...
function tbClass:OnInit()
    ...
    WidgetUtils.SetCollapsedOrSelfHitTestInvisible(self.Completed, self.tbCfg:IsCompleted())
end

function tbClass:UpdateNewDot(bUnLock)
    local IsCompleted = self.tbCfg:IsCompleted()
