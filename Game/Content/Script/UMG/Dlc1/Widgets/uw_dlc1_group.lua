...
local tbWidgetPath = {
    [0] = '/Game/UI/UMG/DLC1/Widgets/uw_dlc1_level_common.uw_dlc1_level_common_C',
    [1] = '/Game/UI/UMG/DLC1/Widgets/uw_dlc1_level_boss.uw_dlc1_level_boss_C',
    [2] = '/Game/UI/UMG/DLC1/Widgets/uw_dlc1_level_plot.uw_dlc1_level_plot_C',
    [7] = '/Game/UI/UMG/DLC1/Widgets/uw_dlc1_level_plot.uw_dlc1_level_plot_C',
}
...
function tbClass:LoadLevelWidget(levelConf, parent, fClickFun)
    ...
    if Widget then
        ...
        local function ClickFunc(cfg)
            local bUnLock, sLockDes = Condition.Check(cfg and cfg.tbCondition)
        ...
        Widget:Init(levelConf.nID, ClickFunc)
    end
    return Widget
end

function tbClass:FoucsItem(pWidget)
    local pLevelUI = UI.GetUI('Dlc1Story')
    if pLevelUI then
